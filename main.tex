...
%Estas certificaciones aportan criterios objetivos para ayudar a investigadores e instituciones a seleccionar el repositorio más adecuado para depositar sus datasets.


\bchregi -----------------revision DE ESTA SECCIÓN hasta acá--------------------------- \echregi \\

\bchregi mover a otro lado lo que sigue o borrarlo \\
...
\centering
    ...
    \hline
    OpenDOAR & Permite conocer información básica como dirección de acceso o información de contacto y tipo de información manejada por el repositorio. \\ \hline
    ROAR & Además de proporcionar información similar a la de OpenDOAR, permite conocer la disciplina asociada al repositorio. Se especializa en repositorios de publicaciones académicas, aunque puede contenter repositorios de datos de investigacion de manera casual. \\ \hline
    Re3data & De manera análoga a ROAR, Re3data se especializa en describir repositorios de investigación, aunque de datos. Es el catálogo que provee la mayor cantidad de registros de repositorios. Publica vigencia de certificaciones. \\ \hline
    FAIRsharing & Destaca por su capacidad de navegar entre las relaciones de los estándares y políticas con los diferentes repositorios de datos. Incluye repositorios de investigacion, aunque estos pueden ser de datos, de artículos, de multimedia, de software, etc. Publica adhesión a principios FAIR. \\ \hline
    DataCite Commons & Integra información sobre repositorios de investigación de diversa índole, y destaca por proveer información relativa al contenido de los mismos de manera sintética, aunque no permite conocer tan a detalle algunas características propias del repositorio ni proporciona criterios de filtrado tan avanzados como Re3data. \\ \hline
    OpenAIRE & De manera similar a DataCite, permite conocer, aunque no permite navegar entre las relaciones de los repositorios con tanta facilidad como FAIRSharing. Destaca la calidad con la que se maneja la procedencia de los datos, permitiendo conocer que repositorios comparten contenidos y de cual de los anteriores catálogos proviene la información del repositorio. \\ \hline
    \end{tabular}
...
%    \item \textbf{DataCite Commons} ofrece información detallada sobre el contenido de cada repositorio, lo que puede ser útil para los investigadores que buscan datos específicos.
...
%\echregi
%\bchgon
% De manera que los identificadores persistentes DOI suelen también incluír metadatos
%\echgon
...
%Una de las prácticas para capturar el contexto de la investigación implica declarar el artículo relacionado (en caso de que exista uno) a los datos recolectados. También es recomendable, a pesar de que no forme parte de los metadatos publicados, adjuntar junto con los datos una guía que facilite la interpretación de los mismos, adjuntar software utilizado o incluso utilizar formatos abiertos para codificar los datos.
...
%Existen otros aspectos a considerar que dependen de factores políticos o legales, los cuales incluyen licencias aceptadas, términos de uso, términos de publicación,  y políticas de preservación (sostenibilidad). 
...
%Algunos catálogos, como FAIRSharing, facilitan la evaluación de estos factores permitiendo identificar la relación entre las políticas específicas de cada repositorio con políticas más generales.\\
%Si tomamos el ejemplo de la NIH como financiador, este podría imponer el cumplimiento de sus términos de uso de datos \footnote{\label{nih_policy_fairsharing} 2023 Final NIH Policy for Data Management and Sharing - \url{https://fairsharing.org/FAIRsharing.7861ef}}. Bajo este escenario, FAIRSharing muestra es capaz de desplegar aquellos repositorios compatibles con esta política mediante el grafo en \ref{fig:fairsharing_nih_policy_repo_usages}, u otras relaciones relevantes mostradas en \ref{fig:fairsharing_nih_policy_relations} como las políticas que el NIH ya considera.
%----------------------------------------------
%\begin{figure}[h]
%    \includegraphics[width=0.5\textwidth]{img/FAIRSharing_NIHPol_relations.png}
%    \caption{
%    Grafo de uso políticas relacionadas con la política del NIH - FAIRSharing - Obtenido el 26/06/2025
%    }
%    \label{fig:fairsharing_nih_policy_relations}
%\end{figure}
%----------------------------------------------------------------------------------
...
%    \caption{Búsqueda general de repositorios de investigación en educación filtrando en base a las certificaciones disponibles - DataCite - Obtenido el 26/06/2025}
...
%Las relaciones de los repositorios con diferentes instituciones también son desplegadas de manera oportuna y pueden servir para evaluar la sostenibilidad o las políticas asociadas. Catálogos como re3data o FAIRSharing proveen una visión clara de estas relaciones de manera resumida y centralizada (ver Fig.\ref{re3data_institutions} y Fig.\ref{fairsharing_institutions} respectivamente).\\
...
%la adecuación de la información provista por los catálogos, para la evaluación de la calidad de los repositorios por parte de los investigadores. Este análisis se basa en los atributos de calidad identificados a partir de la revisión bibliográfica y consulta a experto.
\echedel 
...
%      &   &  \\  
     ...
     \emph{Catálogo que provee la información} \\  \hline
    Reputación &  Reconocimiento  & Re3data, FAIRSharing  \\ \hline
    Usabilidad, interfaz intuitiva & Facilidad de uso & FAIRsharing      \\ \hline
    Disponibilidad de metadatos &  Información de contexto & Re3data, FAIRSharing,   \\ 
       &   & DataCite Commons, OpenAIRE \\  \hline
    Cumplimiento de principios FAIR  &  Acceso y reuso de datos, & DataCite Commons, FAIRSharing,  \\
        & interoperabilidad & OpenAIRE \\ \hline
 Servicios de preservación   & Disponibilidad e integridad de datos  & Re3data, FAIRsharing  \\
 a largo plazo  &   &   \\
    \hline 
 \end{tabular} 
 }\end{center}
